...
[![Live Demo](https://img.shields.io/badge/Live-Demo%20on%20Render-indigo?style=for-the-badge&logo=render)](https://auxi.onrender.com)
[![Node.js](https://img.shields.io/badge/Node.js-v18%2B-green?style=for-the-badge&logo=nodedotjs)](https://nodejs.org/)
[![Socket.io](https://img.shields.io/badge/Socket.io-v4.x-black?style=for-the-badge&logo=socketdotio)](https://socket.io/)
...
- **`public/index.html`** — Landing page (Mode Selection)
- **`public/host.html`** — Driver / Host Dashboard
- **`public/passenger.html`** — Passenger Interface
...
🔗 **Live Link:** [https://auxi.onrender.com](https://auxi.onrender.com)

---

## 👥 Contributor

- **Samiksha R Singi** — Lead Developer & Creator ([GitHub Profile](https://github.com/Samikshagit-07))
